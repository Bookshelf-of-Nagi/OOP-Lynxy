...
class Tokenizer{
	...
	string ret,_fn;
	int ch;
//	const regex r_number = regex("-?(0(0|[1-7][0-7]*)|0x(0|[1-9a-fA-F][0-9a-fA-F]*)|(0|[1-9]\\d*(\\.\\d*)?((e|E)(\\+|-)?\\d*)?))");
//	const regex r_string("\\"\\.*\\"");
//	const regex r_boolean = regex("(true|false)");
//	const regex r_identifier = regex("\\w(\\d|\\w)*");
//	const regex r_operator = regex("~|!|%=|%|\\^=|\\^|&=|&|*=|*|\\(|\\)|-=|--|-|->|\\+\\+|\\+=|\\+|==|=|\\{|\\}|\\[|\\]|::|:|\\?|;|\\/=|\\/|<<|<|>>|>|,|\\.|\\\"|\\\'|\\|=|\\|");
